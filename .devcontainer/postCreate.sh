...
printf '  3. bash scripts/codespaces/build_public_chr22y_index.sh --threads 4\n'
printf '  4. bash scripts/codespaces/run_bulk_public_demo.sh --dry-run --genome-dir /path/to/index\n'
printf '  5. bash scripts/codespaces/run_slam_public_demo.sh --dry-run --genome-dir /path/to/index\n\n'
