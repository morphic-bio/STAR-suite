...
for loc in \
    "/mnt/pikachu/STAR-suite/tests/tmp_wt_snp_comparison/gedi_snp.snpdata" \
...
for loc in \
    "/mnt/pikachu/STAR-suite/tests/tmp_wt_snp_comparison/gedi_cov20_matched.bed" \
...
if [ -z "$GEDI_MASK" ] && [ -z "$GEDI_SNPDATA" ]; then
    ...
    echo "  - /mnt/pikachu/STAR-suite/tests/tmp_wt_snp_comparison/"
