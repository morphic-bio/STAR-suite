...
- `/tmp/star_suite_cbq_star_input_smoke` (synthetic STAR CBQ input smoke: tiny genome, paired/single-end source FASTQ, CBQ generated by `bqtools`, FASTQ-vs-CBQ alignment outputs, and SAM body parity dumps)
