...
SC_RNA_SEQ_ROOT="${SC_RNA_SEQ_ROOT:-}"
...
INSPECT_ANNDATA="${INSPECT_ANNDATA:-}"
...
if [[ -n "${INSPECT_ANNDATA}" ]]; then
  ...
  printf 'AnnData summary inspector not configured; set INSPECT_ANNDATA to enable.\n' \
