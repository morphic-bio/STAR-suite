...
Current production release: **STAR Suite v1.8.3**. The suite release tag and
source-packaging version are `v1.8.3` / `1.8.3-1`; `STAR --version` reports
`1.8.3`. GitHub Releases also provides Ubuntu 22.04- and 24.04-built `.deb`
