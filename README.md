...
Current production release: **[STAR Suite v1.9.2](https://github.com/morphic-bio/STAR-suite/releases/tag/v1.9.2)**. The suite release tag and
source-packaging version are `v1.9.2` / `1.9.2-1`; `STAR --version` reports
`1.9.2`. GitHub Releases also provides Ubuntu 22.04- and 24.04-built `.deb`
