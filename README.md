...
Current production release: **[STAR Suite v1.9.1](https://github.com/morphic-bio/STAR-suite/releases/tag/v1.9.1)**. The suite release tag and
source-packaging version are `v1.9.1` / `1.9.1-1`; `STAR --version` reports
`1.9.1`. GitHub Releases also provides Ubuntu 22.04- and 24.04-built `.deb`
