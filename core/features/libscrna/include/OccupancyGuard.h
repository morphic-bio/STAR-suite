/**
 * @file OccupancyGuard.h
 * @brief Occupancy/FRP guard helper for filtering high-occupancy GEMs
 * 
 * Matches Cell Ranger Python defaults exactly (immutable CR defaults).
 */
