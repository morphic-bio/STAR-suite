/**
 * @file EmptyDropsMultinomial.h
 * @brief EmptyDrops multinomial p-value computation
 * 
 * Implements ambient profile computation and Monte Carlo p-value calculation
 * using Cell Ranger-style algorithms.
 */
