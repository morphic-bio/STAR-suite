/**
 * @file CRLogProb.h
 * @brief DropletUtils-style dense multinomial log-probability computation
 */
 ...
 * 
 * @param counts Pointer to counts for this cell
 * @param geneIds Pointer to gene IDs for this cell (same length as counts)
 * @param ambientLogP Dense log probabilities for all genes (length = nFeatures)
 * @return log-likelihood as double
 */
