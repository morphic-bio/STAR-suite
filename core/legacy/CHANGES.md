...
===================================================
* Added indexed, record-ordinal BGZF range readers for supported fully-fused STAR-Flex runs, including structurally complete files without the optional canonical EOF member.
