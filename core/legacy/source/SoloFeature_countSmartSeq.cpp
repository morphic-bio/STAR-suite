...
{    
    ...
    for (uint32 ired=0; ired<redistrFilesCBfirst.size()-1; ired++) {//TODO: parallelize, each ired is independent here!
        ...
        while (soloInputFeatureUMI(redistrFilesStreams[ired], featureType, readInfoYes, false, P.sjAll, iread, cbmatch, feature, umi, trIdDist, readFlagCounts)) {//cycle over file records
